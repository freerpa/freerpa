<template>
  <div class="cache-manager">
    <a-card title="缓存管理" :bordered="false">
      <template #extra>
        <a-popover content="缓存包含浏览器 Session 数据（Cookie、LocalStorage 等）和 Chromium 运行时临时文件。清空缓存不会影响您的浏览器配置和工作流数据。">
      ...
      <div class="cache-info">
        <div class="size-display">
          ...
          <a-button type="outline" size="small" style="margin-left: 12px" @click="refresh" :loading="loading">
