<template>
  <div class="login-container">
    ...
    <div class="login-box">
      ...
      <LoginByPhone v-if="loginType === 'phone'" />
      <LoginByEmail v-else-if="loginType === 'email'" />
      <loginByWeChat v-else-if="loginType === 'qrcode'" />
...
import { IconMobile, IconEmail, IconWechat } from '@arco-design/web-vue/es/icon'
...
import loginByWeChat from './components/loginByWeChat.vue'
